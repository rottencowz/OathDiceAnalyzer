...
var $author$project$OathDice$Empty = {$: 'Empty'};
...
var $author$project$OathDice$rollDefenseDice = function (count) {
	return A2(
...
var $author$project$OathDice$Single = {$: 'Single'};
var $author$project$OathDice$Skull = {$: 'Skull'};
var $author$project$OathDice$rollOffenseDice = function (count) {
	return A2(
		$elm$random$Random$list,
		count,
		A2(
...
var $author$project$OathDice$rollGenerator = function (input) {
	var offense = $author$project$OathDice$rollOffenseDice(input.attackingDice);
	var defense = $author$project$OathDice$rollDefenseDice(input.defendingDice);
	var generator = A3(
		$elm$random$Random$map2,
		F2(
			function (a, b) {
				return _Utils_Tuple3(input, a, b);
			}),
		offense,
		defense);
	return generator;
...
var $author$project$OathDice$summarizeDefenseRoll = function (defense) {
	return A3(
		...
		F2(
			function (roll, _v0) {
				var shield = _v0.a;
				var multiplies = _v0.b;
				switch (roll.$) {
					case 'Shield':
						return _Utils_Tuple2(shield + 1, multiplies);
					case 'TwoShields':
						return _Utils_Tuple2(shield + 2, multiplies);
					case 'Multiply':
						return _Utils_Tuple2(shield, multiplies + 1);
					default:
						return _Utils_Tuple2(shield, multiplies);
				}
			}),
		_Utils_Tuple2(0, 0),
		defense);
};
var $author$project$OathDice$summarizeOffenseResults = function (offense) {
	return A3(
		$elm$core$List$foldl,
		F2(
			function (roll, _v0) {
				...
				switch (roll.$) {
					case 'Single':
						return _Utils_Tuple2(value + 1, skulls);
					case 'Hollow':
						return _Utils_Tuple2(value + 0.5, skulls);
					default:
						return _Utils_Tuple2(value + 2, skulls + 1);
				}
			}),
		_Utils_Tuple2(0.0, 0),
		offense);
};
var $author$project$OathDice$dec = function (i) {
	return (i <= 0) ? 0 : (i - 1);
};
var $author$project$OathDice$inc = function (i) {
	return i + 1;
};
var $author$project$OathDice$updateInput = F2(
	function (input, desc) {
		if (desc.a.$ === 'Increment') {
			if (desc.b.$ === 'Dice') {
				if (desc.c.$ === 'Offense') {
					...
					return _Utils_update(
						input,
						{
							attackingDice: $author$project$OathDice$inc(input.attackingDice)
						});
				} else {
					var _v7 = desc.a;
					var _v8 = desc.b;
					...
					return _Utils_update(
						input,
						{
							defendingDice: $author$project$OathDice$inc(input.defendingDice)
						});
				}
			} else {
				if (desc.c.$ === 'Offense') {
					...
					return _Utils_update(
						input,
						{
							attackingTroops: $author$project$OathDice$inc(input.attackingTroops)
						});
				} else {
					var _v19 = desc.a;
					var _v20 = desc.b;
					...
					return _Utils_update(
						input,
						{
							defendingTroops: $author$project$OathDice$inc(input.defendingTroops)
						});
				}
			}
		} else {
			if (desc.b.$ === 'Dice') {
				if (desc.c.$ === 'Offense') {
					...
					return _Utils_update(
						input,
						{
							attackingDice: $author$project$OathDice$dec(input.attackingDice)
						});
				} else {
					var _v10 = desc.a;
					var _v11 = desc.b;
					...
					return _Utils_update(
						input,
						{
							defendingDice: $author$project$OathDice$dec(input.defendingDice)
						});
				}
			} else {
				if (desc.c.$ === 'Offense') {
					...
					return _Utils_update(
						input,
						{
							attackingTroops: $author$project$OathDice$dec(input.attackingTroops)
						});
				} else {
					var _v22 = desc.a;
					var _v23 = desc.b;
					...
					return _Utils_update(
						input,
						{
							defendingTroops: $author$project$OathDice$dec(input.defendingTroops)
						});
				}
			}
		}
	});
var $author$project$OathDice$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Modify':
				var action = msg.a;
			...
			case 'RollGenerated':
				...
				var roll = A2(
					$elm$core$Array$get,
					index,
					$elm$core$Array$fromList(model.backgroundRolls));
			...
			default:
				...
				return _Utils_Tuple2(
					...
					$author$project$OathDice$passBatchedRollsToPlotly(
						_Utils_Tuple2(
							model.input,
							A2(
								$elm$core$List$map,
								function (_v1) {
									...
									var defense = _v1.c;
									return {
										summarizedDefense: $author$project$OathDice$summarizeDefenseRoll(defense),
										summarizedOffense: $author$project$OathDice$summarizeOffenseResults(offense)
									};
								},
								rolls))));
		}
...
var $author$project$OathDice$Defense = {$: 'Defense'};
...
var $author$project$OathDice$Decrement = {$: 'Decrement'};
var $author$project$OathDice$Increment = {$: 'Increment'};
var $author$project$OathDice$Modify = F3(
	function (a, b, c) {
		return {$: 'Modify', a: a, b: b, c: c};
	});
var $elm$html$Html$td = _VirtualDom_node('td');
var $author$project$OathDice$viewField = F3(
	function (value, field, side) {
		return A2(
			$elm$html$Html$td,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							A3($author$project$OathDice$Modify, $author$project$OathDice$Increment, field, side))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('+')
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							A3($author$project$OathDice$Modify, $author$project$OathDice$Decrement, field, side))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('-')
...
var $author$project$OathDice$viewInputState = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Attacker Dice')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Attacker Troops')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Defender Dice')
									])),
								A2(
								$elm$html$Html$th,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Defender Troops')
									]))
							])),
						A2(
						$elm$html$Html$tr,
						...
						_List_fromArray(
							[
								A3($author$project$OathDice$viewField, model.input.attackingDice, $author$project$OathDice$Dice, $author$project$OathDice$Offense),
								A3($author$project$OathDice$viewField, model.input.attackingTroops, $author$project$OathDice$Troops, $author$project$OathDice$Offense),
								A3($author$project$OathDice$viewField, model.input.defendingDice, $author$project$OathDice$Dice, $author$project$OathDice$Defense),
								A3($author$project$OathDice$viewField, model.input.defendingTroops, $author$project$OathDice$Troops, $author$project$OathDice$Defense)
							]))
					]))
			]));
};
...
var $author$project$OathDice$viewDefenseRoll = function (defense) {
	var defenseValues = $author$project$OathDice$summarizeDefenseRoll(defense);
	var defenseRoll = defenseValues.a * A2($elm$core$Basics$max, 1, defenseValues.b);
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text('Defense roll value: '),
				$elm$html$Html$text(
				$elm$core$String$fromInt(defenseRoll))
			]));
};
var $author$project$OathDice$viewOffenseRoll = function (offense) {
	var offenseValues = $author$project$OathDice$summarizeOffenseResults(offense);
	var selfDamage = offenseValues.b;
	var damage = $elm$core$Basics$floor(offenseValues.a);
	var offenseString = $elm$core$String$fromInt(damage) + (' damage, with ' + ($elm$core$String$fromInt(selfDamage) + ' immediate loses.'));
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text('Offense roll value: '),
				$elm$html$Html$text(offenseString)
			]));
};
var $author$project$OathDice$viewRollResult = function (model) {
	var _v0 = model.roll;
	if (_v0.$ === 'Just') {
		var _v1 = _v0.a;
		var inputs = _v1.a;
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$OathDice$viewOffenseRoll(offense),
					$author$project$OathDice$viewDefenseRoll(defense)
				]));
	} else {
		return A2($elm$html$Html$br, _List_Nil, _List_Nil);
	}
};
var $author$project$OathDice$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Oath Dice Randomizer')
					])),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$author$project$OathDice$viewInputState(model),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$OathDice$Roll)
					]),
				_List_fromArray(
					[
...
var $author$project$OathDice$main = $elm$browser$Browser$element(
	{
		init: $author$project$OathDice$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$OathDice$update,
